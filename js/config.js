    ...
    "5": {
      ...
      "build": {
        ...
        "extraSpots": [
          ...
          { "x": 688, "y": 328 }, { "x": 760, "y": 328 },  // 下路上方一排
          { "x": 856, "y": 400 }, { "x": 856, "y": 460 },  // 右延伸段（覆盖 820→940 新路）
          { "x": 904, "y": 400 }, { "x": 904, "y": 460 }   // 右延伸段更右端（覆盖 900→940）
        ]
      },
      ...
      "paths": [
        ...
        /* route 1：下路（右下出怪 → 跨路传送 B 出口 → 右终点，终点向右延伸至右下角） */
        [
          { "x": 1000, "y": 470 },
