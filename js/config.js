    ...
    "5": {
      ...
      "build": {
        ...
        "extraSpots": [
          ...
          { "x": 688, "y": 400 }, { "x": 760, "y": 400 },  // 下路水平段(y=340)下方一排
          { "x": 832, "y": 400 }, { "x": 904, "y": 400 },  // 右延伸水平段(y=340)下方一排
          { "x": 832, "y": 278 }, { "x": 904, "y": 278 }   // 右延伸水平段(y=340)上方一排
        ]
      },
      ...
      "paths": [
        ...
        /* route 1：下路（右下出怪 → 跨路传送 B 出口 → 右终点；B 出来后水平道路直接向右延伸至右下角） */
        [
          { "x": 1000, "y": 470 },
          { "x": 620, "y": 470 },   // w1 = 传送门 C（入口）
          { "x": 620, "y": 340 },   // w2 = 传送门 B（出口）
          { "x": 940, "y": 340 },   // w3 = B 所在水平道路向右延伸
          { "x": 940, "y": 515 }    // w4 = 右终点洞穴（延伸末端，右下角）
        ],
